...
I believe that the tools we build are good, only if we use them ourselves, and the reality is I don't use this `wp-cli-deploy` anymore, so I decided to hand off maintenance of this project to someone else.
